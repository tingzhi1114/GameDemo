...
public class LocationData
{
    ...
    // 生产力系数（key=物品ID, value=生产力系数，影响该地该物品的价格）
    public Dictionary<int, float> productivity;

    public LocationData(int id, string name, LocationTypeEnum type, Dictionary<int, int> connections, int top_scene_id = -1, Dictionary<int, float> productivity = null)
    {
        this.id = id;
        this.name = name;
        this.type = type;
